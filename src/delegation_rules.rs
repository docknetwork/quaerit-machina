use crate::types::RdfNode::{self, Iri};
...
mod test {
    ...
    fn dock(suffix: &str) -> rify::Entity<&str, RdfNode> {
        bound("https://dock.io/rdf/alpha/", suffix)
    }

    fn rdf(suffix: &str) -> rify::Entity<&str, RdfNode> {
        bound("http://www.w3.org/1999/02/22-rdf-syntax-ns#", suffix)
    }

    fn rdfs(suffix: &str) -> rify::Entity<&str, RdfNode> {
        bound("http://www.w3.org/2000/01/rdf-schema#", suffix)
    }

    fn bound(pre: &str, suff: &str) -> rify::Entity<&'static str, RdfNode> {
